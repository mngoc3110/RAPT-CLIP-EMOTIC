#!/bin/bash
# EMOTIC — 2-Stream (Body + Context) with Combined Prompts
#
# Architecture: 2-Stream RAPT-CLIP (NO Face)
...
#
# Usage: bash train_sh/train_emotic_2stream_body_ctx.sh

export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python main.py \
  --mode train \
  --exper-name EMOTIC-2Stream-BodyCtx-Combined \
  --dataset EMOTIC \
  --gpu 0 \
  --workers 0 \
  --use-amp \
